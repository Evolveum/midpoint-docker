...
##################################################################
# File is located here for the compatibility with version < 4.4.
#
# It will be remove once support of these version will ends.
# By the https://docs.evolveum.com/midpoint/release/ page it will
#  be at 08 Sep 2022
#
# The content of the file is the same as the file distributed in
# the archive with the midpoint ( tar.gz ).
##################################################################
